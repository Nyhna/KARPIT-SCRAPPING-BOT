...
SMEX_USERS = [5151463162, 1877225844]
for x in SUDO:
    SMEX_USERS.append(x)
...
async def get_users(event):
    if event.sender_id in SMEX_USERS:
        ...
        await krishna.edit(
            "**⚜️[Ͳєямιиαℓ Տτατυѕ](https://t.me/NYHNA_SUPPORT)**\n\n`🔸Inviting Users.......`"
        )
...
print(text)
print("")
print("🙏🔥🔥 BOT CHAL GYA RE SHAAM BALTI LAA.🔥🔥🙏")
